                    ...
                    if(typeof nonInjectableServices[v] === 'object') {
                        if (Array.isArray(nonInjectableServices[v])) {
                            ...
                            if (!activeEnvironment[v]) {
                                activeEnvironment[v].logger.critical(`error - environment did not include config for ${v} skipping...`);
                            }
                            if(nonInjectableServices[v].some( k => {
                                ...
                                activeEnvironment[v].logger.critical(` ${v} data services appears to be misconfigured\n`);
                            }
